            ...
            <tr v-for="(user, key) in users" :key="key" class="m-5">
                ...
                <th>
                    <div class="grid grid-cols-3">
                        <button class="justify-self-center" @click.prevent="refreshUser(user.id)"><RefreshIcon class="transition-colors duration-200 h-8 dark:bg-[#f0f0f0] bg-[#3B3F43] dark:text-[#3B3F43] text-[#f0f0f0] rounded-md p-0.5 mx-1" /></button>
