<template>
    <div class="mt-8 gridCreator text-black dark:text-white">
      <div class="md:grid grid-cols-5 gap-4">
        ...
        <Bloc class="rounded-xl text-black col-span-2 min-h-[80vh] md:max-h-[80vh] overflow-auto row-start-2">
            <AreaCreatorComponent/>
        </Bloc>
        <p class="col-span-3">Your AREAs</p>
        <CarouselComponent class="col-span-3 row-start-2 md:grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-4 overflow-auto sm:max-h-[80vh]" />
      </div>
    </div>
</template>
